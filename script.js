 // ======= DATA MODEL (LOCAL STORAGE DEMO) =======
    const STORAGE_KEY = "callflow_crm_demo_v1";
    ...
    function setLoginRole(role) {
      ...
      if (role === "admin") {
        ...
        loginHint.textContent = "Default admin: admin@crm";
      } else {
        ...
        loginHint.textContent = "Use admin-created employee user ID";
      }
      ...
      tr.innerHTML = `
        ...
        <td>
          <select class="select-control client-status" data-client-id="${client.id}">
            ...
            <option ${
              client.status === "Not Received" ? "selected" : ""
            }>Not Received</option>
            <option ${
              client.status === "Busy" ? "selected" : ""
            }>Busy</option>
            <option ${
              client.status === "Not Incoming" ? "selected" : ""
            }>Not Incoming</option>
            <option ${
              client.status === "Interested" ? "selected" : ""
            }>Interested</option>
            <option ${
              client.status === "Not Interested" ? "selected" : ""
            }>Not Interested</option>
            <option ${
              client.status === "Follow-up" ? "selected" : ""
            }>Follow-up</option>
            <option ${
              client.status === "Converted" ? "selected" : ""
            }>Converted</option>
          </select>
        </td>
        <td>
